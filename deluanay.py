...
##    Hacked up for Rhino Python by: Robin Wilis                                                                    ##                                                                                        ##
##    Last modified: 29.01.11 by Robin Willis                                                                       ##
##                                                                                                                  ##
######################################################################################################################
...
##
##pointSet = rs.GetObjects("SelectPoints")
##d = Delaunay(pointSet)
##d.triangulate()
...
class Delaunay:
    def __init__(self, points):
        ...
        self.vertices = [rs.PointCoordinates(i) for i in points]
        #print self.vertices
    ...
    def triangulate(self):
        ...
        triLayer = rs.AddLayer("DELUAUNY TRIANGULATION", Color.DarkSeaGreen)
        rs.CurrentLayer(triLayer)
